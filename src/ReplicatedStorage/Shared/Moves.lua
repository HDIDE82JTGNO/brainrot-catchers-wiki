...
-- Constructor helper
local function createMove(basePower: number, accuracy: number, priority: number, typeValue, description: string?, healsPercent: number?): Moves_Type
    return {
        BasePower = basePower,
        Accuracy = accuracy,
        Priority = priority,
...
return { -- BasePower, Accuracy, Priority, Type, Description
    ...
    ["Bite"] = createMove(50, 95, 0, Types.Dark, "A quick, vicious bite."),
    ...
    ["Uppercut"] = createMove(70, 100, 0, Types.Fighting, "A rising punch aimed at the chin."),
    ["Knockout"] = createMove(150, 30, 0, Types.Fighting, "A devastating punch that rarely connects."),
    -- Grass type moves
    ...
    -- Psychic type moves
    ["Mind Slam"] = createMove(80, 100, 0, Types.Psychic, "Throws mental force like a hammer."),
    -- Steel type moves
    ["Shield Bash"] = createMove(75, 100, 0, Types.Steel, "Bashes the foe with a sturdy guard."),
    -- Fairy type moves
    ["Dazzle Beam"] = createMove(80, 100, 0, Types.Fairy, "Fires a brilliant, disorienting ray."),
    ...
    -- Poison type moves (new)
    ["Ooze Shot"] = createMove(50, 100, 0, Types.Poison, "Fires a glob of toxic ooze."),
    ["Sludge Puff"] = createMove(60, 100, 0, Types.Poison, "A burst of sludge coats the foe."),
    ["Toxic Wave"] = createMove(80, 90, 0, Types.Poison, "A rolling poisonous wave engulfs the foe."),
    ["Corrosive Grasp"] = createMove(70, 95, 0, Types.Poison, "Burning toxins grasp and corrode armor."),
    ["Acidic Deluge"] = createMove(95, 85, 0, Types.Poison, "Drowns the foe in corrosive acid."),
}
